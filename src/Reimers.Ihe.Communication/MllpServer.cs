namespace Reimers.Ihe.Communication
{
    ...
    public class MllpServer : IDisposable
    {
        ...
        private Task _readTask;        /// <summary>
        ...
        }        private async Task Read()
        {
            ...
            {
                var client = await _listener.AcceptTcpClientAsync().ConfigureAwait(false);                var connection = await MllpHost.Create(client, _middleware, _encoding, _serverCertificate);
                lock (_connections)
                {
